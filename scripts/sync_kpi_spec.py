#!/usr/bin/env python3
"""Copy build/kpi_reports.py's SPEC into kpi-core.js.
...
into kpi-core.js — the engine admin.html and kpis.html share — between the
KPI-REPORT-SPEC markers. Run this after touching SPEC (adding a real vendor
header, say); build/tests/test_kpi_spec_parity.py fails if the two ever drift.

Usage: py scripts/sync_kpi_spec.py [kpi-core.js]
"""
import os
import re
import sys
...
def main():
    path = sys.argv[1] if len(sys.argv) > 1 else "kpi-core.js"
